...
export default function BalcaoPage() {
  ...
  useEffect(() => {
    setLocalOrders(
      orders.filter((o) => o.orderType === "PICKUP" && o.status !== "CANCELLED")
    );
  }, [orders]);
  ...
  async function handleStatusChange(
    ...
    try {
      ...
      console.error("🚨 [BalcaoPage] Failed to update status:", err);
      refetch();
    }
  }
  ...
  async function handleCancel(orderId: string) {
    ...
    try {
      ...
      console.error("🚨 [BalcaoPage] Failed to cancel order:", err);
      refetch();
    }
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold">Pedidos - Balcão</h1>
